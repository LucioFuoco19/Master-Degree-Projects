        ...
        egui::Frame::none()
            ...
            .show(ui, |ui| {
                ui.vertical_centered(|ui| {
                    ...
                    // --- SUBTITLE ---
                    ui.label(
                        RichText::new("Login to your Ruggine account.")
                            .size(15.0)
                        ...
                        ui.with_layout(Layout::top_down(Align::Min), |ui| {
                            ...
                            ui.add(
                                egui::TextEdit::singleline(&mut app.login_username)
                                    .hint_text("Insert your username")
                            ...
                            ui.horizontal(|ui| {
                                // center the button group like in home.rs
                                ...
                                if ui.add_enabled(!app.is_loading, login_btn).clicked() {
                                    let tx = app.get_tx();
                                    app.is_loading = true;
                                    app.status = "Connection to the server…".into();
                                    ...
                                    handle.spawn(async move {
                                        let result = net::login(&addr, &user, &pass).await;
